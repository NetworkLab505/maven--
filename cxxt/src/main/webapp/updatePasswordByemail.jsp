...
<!--logo设计-->
 <div class="header">
   ...
   &nbsp; <span id="spanone">通过QQ邮箱找回创新课堂密码 </span>
    ...
    <form  action="${pageContext.request.contextPath}/user_updatePaWByemail" method="post">
    <div id="middle">
            <p class="p_two" >请输入邮箱号</p>
            <input type="text"  id="mail" name="mail" maxlength="19"    >
            <span  style="color: red" id="psspan"></span>
            <br>


        <input type="submit" id="btn"  value="找回密码" style="background-color:#2aabd2; width: 67px; height: 31px"  onclick="return RcheckUser()">
    </div>
    </form>
    <!--页尾-->
