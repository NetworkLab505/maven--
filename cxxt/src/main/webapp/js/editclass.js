...
function modify(obj){
    ...
    var oCourse_name = document.getElementById('Course_name');
    var oKeynote_speaker = document.getElementById('Keynote_speaker');
    var oClicks = document.getElementById('Clicks');
    var oUploadtime = document.getElementById('Uploadtime');
    ...
    oCourse_name.value = aTd[3].innerHTML;
    oKeynote_speaker.value = aTd[4].innerHTML;
    oClicks.value = aTd[5].innerHTML;
    oUploadtime.value = aTd[6].innerHTML;
    console.log(aTd[7].innerHTML);
    //alert(i);
}
//更新功能
function update(){
    ...
    otable.rows[rowIndex].cells[3].innerHTML = oCourse_name.value;
    otable.rows[rowIndex].cells[4].innerHTML = oKeynote_speaker.value;
    otable.rows[rowIndex].cells[5].innerHTML = oClicks.value;
    otable.rows[rowIndex].cells[6].innerHTML = oUploadtime.value;
}